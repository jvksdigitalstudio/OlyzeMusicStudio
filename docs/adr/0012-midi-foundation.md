...
`OlyzeMidiManager` (salida) a `EliNerMidiApi` — **cerrado en ADR 0013**:
`OlyzeMidiManager` fue reemplazado por `MidiOutputBridge`, sobre la misma
`EliNerMidiApi`. MPE real (per-note
