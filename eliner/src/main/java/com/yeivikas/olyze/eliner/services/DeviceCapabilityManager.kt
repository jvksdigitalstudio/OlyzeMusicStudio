 ...
 *
 * [context] should be an application context — this class holds onto it
 * for the lifetime of the manager, so passing an Activity context would
 * leak it.
 */
class DeviceCapabilityManager(private val context: Context) : CapabilityProvider {
